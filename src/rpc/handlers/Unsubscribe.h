...
private:
    ...
    unsubscribeFromStreams(
        ...
        std::shared_ptr<ServerNG::ConnectionBase> const& session) const
    {
    ...
    void
    unsubscribeFromAccounts(std::vector<std::string> accounts, std::shared_ptr<ServerNG::ConnectionBase> const& session)
        const
    {
    ...
    void
    unsubscribeFromBooks(std::vector<OrderBook> const& books, std::shared_ptr<ServerNG::ConnectionBase> const& session)
        const
    {
